document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      let existingSuccess = contactForm.querySelector('.form-success-message');
      ...
      function showFormSuccess() {
        ...
        successMsg.textContent =
          contactForm.dataset.successMessage || 'Thank you! Your message has been sent.';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Twins Brands משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5447eacc-f95e-4c69-bbe5-2a6990113e0f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5447eacc-f95e-4c69-bbe5-2a6990113e0f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5447eacc-f95e-4c69-bbe5-2a6990113e0f';
